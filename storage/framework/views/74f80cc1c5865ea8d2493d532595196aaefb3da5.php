                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="e_name" value="<?php echo e(old('c_name')); ?>" required autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="dept_id">
                                   ...
                                   foreach($departments as $dept)
                                        ...
                                        {?>
                                             <option value="<?php echo e($dept->id); ?>"><?php echo e($dept->d_name); ?></option>
                                        <?php
                                        }?>
